...
import im.ene.lab.kazora.data.MockApi;
...
@Singleton @Module public class ApiModule {
  ...
  public ApiModule(Kazora app) {
    this.app = app;
  }

  @Singleton @Provides Api provideApi(Retrofit retrofit, Gson gson) {
    ...
    return new MockApi(delegate, new Mocker(app.getAssets(), gson));
  }
}
