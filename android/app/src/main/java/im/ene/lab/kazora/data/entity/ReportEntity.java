...
public class ReportEntity extends RealmObject implements BaseEntity<ReportModel> {
  ...
  @SerializedName("min_temp_fahrenheit") @Expose public Integer minTempFahrenheit;
  @SerializedName("max_temp") @Expose public Integer maxTemp;
  @SerializedName("max_temp_fahrenheit") @Expose public Integer maxTempFahrenheit;
  ...
  @Override public ReportModel toModel() {
    return new ReportModel(this.earthDate);
  }
}
